...
function fiveBarMechanismMassMatrixGeneral
...
int=10;
 ...
 for beta=0:(2*pi/int):2*pi;
    for r=0.01:(.199-.01)/int:.199;
       ...
       beta1=-acos((lsquared-l1^2-l2^2)/(2*l1*l2));
       psi1=asin(-l2/sqrt(lsquared)*sin(beta1));
       if(psi1>pi/2) psi1=psi1-pi/2; end
          
       th1=phi+psi1;
       th2=beta1; 
       
       
       beta2=acos((lsquared-l3^2-l4^2)/(2*l3*l4));
        psi2= asin(l4/sqrt(lsquared)*sin(beta2));
